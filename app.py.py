...
# ADDED: Initialize button states safely
fetch_btn = False
...
with st.sidebar:
    ...
    if "네" in day_type:
        ...
        # ADDED: Dynamic current date instead of hardcoded 2026-07-02
...
if "네" in day_type:
    ...
    # CHANGED: Cleaned up the if condition
    if fetch_btn:
